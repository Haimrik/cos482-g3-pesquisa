...
public interface UsuarioService {
    ...
    /**
     *  Get all the UsuarioDTO where Aluno is null.
     *
     *  @return the list of entities
     */
    List<UsuarioDTO> findAllWhereAlunoIsNull();
    /**
     *  Get all the UsuarioDTO where Professor is null.
     *
     *  @return the list of entities
     */
    List<UsuarioDTO> findAllWhereProfessorIsNull();
