...
public class ProfessorResourceIntTest {
    ...
    private static final String DEFAULT_LINK_LATTES = "AAAAAAAAAA";
    private static final String UPDATED_LINK_LATTES = "BBBBBBBBBB";

    private static final String DEFAULT_PROGRAMA = "AAAAAAAAAA";
    private static final String UPDATED_PROGRAMA = "BBBBBBBBBB";

    private static final String DEFAULT_LINHA_DE_PESQUISA = "AAAAAAAAAA";
    private static final String UPDATED_LINHA_DE_PESQUISA = "BBBBBBBBBB";

    private static final String DEFAULT_AREAS_DE_INTERESSE = "AAAAAAAAAA";
    private static final String UPDATED_AREAS_DE_INTERESSE = "BBBBBBBBBB";
    ...
    public static Professor createEntity(EntityManager em) {
        Professor professor = new Professor()
            ...
            .linkLattes(DEFAULT_LINK_LATTES)
            .programa(DEFAULT_PROGRAMA)
            .linhaDePesquisa(DEFAULT_LINHA_DE_PESQUISA)
            .areasDeInteresse(DEFAULT_AREAS_DE_INTERESSE);
        return professor;
    }
    ...
    public void createProfessor() throws Exception {
        ...
        assertThat(testProfessor.getLinkLattes()).isEqualTo(DEFAULT_LINK_LATTES);
        assertThat(testProfessor.getPrograma()).isEqualTo(DEFAULT_PROGRAMA);
        assertThat(testProfessor.getLinhaDePesquisa()).isEqualTo(DEFAULT_LINHA_DE_PESQUISA);
        assertThat(testProfessor.getAreasDeInteresse()).isEqualTo(DEFAULT_AREAS_DE_INTERESSE);
    }
    ...
    @Test
    @Transactional
    public void checkLinkLattesIsRequired() throws Exception {
        int databaseSizeBeforeTest = professorRepository.findAll().size();
        // set the field null
        professor.setLinkLattes(null);
    ...
    public void getAllProfessors() throws Exception {
        ...
        restProfessorMockMvc.perform(get("/api/professors?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].linkLattes").value(hasItem(DEFAULT_LINK_LATTES.toString())))
            .andExpect(jsonPath("$.[*].programa").value(hasItem(DEFAULT_PROGRAMA.toString())))
            .andExpect(jsonPath("$.[*].linhaDePesquisa").value(hasItem(DEFAULT_LINHA_DE_PESQUISA.toString())))
            .andExpect(jsonPath("$.[*].areasDeInteresse").value(hasItem(DEFAULT_AREAS_DE_INTERESSE.toString())));
    }
    ...
    public void getProfessor() throws Exception {
        ...
        restProfessorMockMvc.perform(get("/api/professors/{id}", professor.getId()))
            ...
            .andExpect(jsonPath("$.linkLattes").value(DEFAULT_LINK_LATTES.toString()))
            .andExpect(jsonPath("$.programa").value(DEFAULT_PROGRAMA.toString()))
            .andExpect(jsonPath("$.linhaDePesquisa").value(DEFAULT_LINHA_DE_PESQUISA.toString()))
            .andExpect(jsonPath("$.areasDeInteresse").value(DEFAULT_AREAS_DE_INTERESSE.toString()));
    }
    ...
    public void updateProfessor() throws Exception {
        ...
        updatedProfessor
            ...
            .linkLattes(UPDATED_LINK_LATTES)
            .programa(UPDATED_PROGRAMA)
            .linhaDePesquisa(UPDATED_LINHA_DE_PESQUISA)
            .areasDeInteresse(UPDATED_AREAS_DE_INTERESSE);
        ...
        assertThat(testProfessor.getLinkLattes()).isEqualTo(UPDATED_LINK_LATTES);
        assertThat(testProfessor.getPrograma()).isEqualTo(UPDATED_PROGRAMA);
        assertThat(testProfessor.getLinhaDePesquisa()).isEqualTo(UPDATED_LINHA_DE_PESQUISA);
        assertThat(testProfessor.getAreasDeInteresse()).isEqualTo(UPDATED_AREAS_DE_INTERESSE);
    }
